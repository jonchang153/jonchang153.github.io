...
In this example, I'll be using one of my favorite movies, "[The Shawshank Redemption](https://www.imdb.com/title/tt0111161/){:target="_blank"}".
...
You can visit [my GitHub project repository](https://github.com/jonchang153/Web-Scraping-with-Scrapy){:target="_blank"} to see the full implementation of my web scraper.